...
const Navbar = () => {
    ...
    // // it is the browser part in applicatioon on console view  locaalstorage
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
                ...
                {/* md means medium or bde device ke liye set krna */}
                <div className="navbar ">
                    <div className="navbar-start">
                        ...
                        <a className="cursor-pointer font-bold text-3xl">BookStore</a>
                    </div>
